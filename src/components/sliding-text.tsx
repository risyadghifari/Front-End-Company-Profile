    ...
    <div className="relative font-inter antialiased">
      <main className="relative flex flex-col justify-center items-center overflow-hidden h-screen">
        <div className="text-center pt-[30px]">
          ...
          <div className="font-extrabold text-3xl md:text-5xl lg:text-6xl [text-wrap:balance] bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 to-50% to-slate-200">
