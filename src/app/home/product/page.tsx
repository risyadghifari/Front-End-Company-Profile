        ...
        <div className="bg-neutral-50">
          ...
          <section>
            ...
            <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                <h2 className={`${interItalic.className} text-3xl pb-8 tracking-tight font-bold text-gray-900 dark:text-gray-800`}>Our Products.</h2>
                <hr className="border-gray-400"/>
                <FadeInSections>
                <h2 className="mb-4 text-1xl pt-[10px] tracking-tight font-bold text-gray-900 dark:text-gray-800">The Pro Series Complete Skateboard - Street Edition is built for skaters who take their craft seriously. Whether you are hitting your local skate park or bombing down city streets, 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <Link href={"/"} className="max-w-[384px] mx-auto">
                        ...
                        <div className="mt-5 flex items-center justify-between">
                            ...
                            <p className="text-gray-800 font-bold">Buy</p>
                            </button>
                        </div>
                    </Link>
