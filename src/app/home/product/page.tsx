          ...
          <section className="py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <Link href={"/"} className="max-w-[384px] mx-auto">
                        <div className="w-full max-w-sm aspect-square overflow-hidden">
                            <Image src={"/catalog/Palace-2024-cap-18653.webp"} alt="skateboard" width={100} height={100} className="w-full h-full  object-cover transition-transform hover hover:scale-[1.3]"></Image>
                        </div>
                        <div className="mt-5 flex items-center justify-between">
                            <div className="">
                    ...
                    <Link href={"/"} className="max-w-[384px] mx-auto">
                        <div className="w-full max-w-sm aspect-square overflow-hidden">
                            <Image src={"/catalog/Palace-Winter-2024-07.webp"} width={100} height={100} alt="skateboard" className="w-full h-full  object-cover transition-transform hover hover:scale-[1.3]"></Image>
                        </div>
                        <div className="mt-5 flex items-center justify-between">
                            <div className="">
                    ...
                    <Link href={"/"} className="max-w-[384px] mx-auto">
                        <div className="w-full max-w-sm aspect-square overflow-hidden">
                            <Image src={"/catalog/polar-roman-lorca.webp"} width={100} height={100} alt="skateboard" className="w-full h-full  object-cover transition-transform hover hover:scale-[1.3]"></Image>
                        </div>
                        <div className="mt-5 flex items-center justify-between">
                            <div className="">
                                <h6 className="font-medium text-[19px] leading-8 text-black mb-2">Palace 8.375 Chewy Pro S37 Skateboard Deck</h6>
                    ...
                    <Link href={"/"} className="max-w-[384px] mx-auto">
                        <div className="w-full max-w-sm aspect-square overflow-hidden">
                            <Image src={"/catalog/BLEDSOE.webp"} width={100} height={100} alt="skateboard" className="w-full h-full  object-cover transition-transform hover hover:scale-[1.3]"></Image>
                        </div>
                        <div className="mt-5 flex items-center justify-between">
                            <div className="">
                                <h6 className="font-medium text-[19px] leading-8 text-black mb-2">Palace 8.375 Chewy Pro S37 Skateboard Deck</h6>
                    ...
                    <Link href={"/"} className="max-w-[384px] mx-auto">
                        <div className="w-full max-w-sm aspect-square overflow-hidden">
                            <Image src={"/catalog/baker-veneers-8.25.webp"} width={100} height={100} alt="skateboard" className="w-full h-full  object-cover transition-transform hover hover:scale-[1.3]"></Image>
                        </div>
                        <div className="mt-5 flex items-center justify-between">
                            <div className="">
                                <h6 className="font-medium text-[19px] leading-8 text-black mb-2">Palace 8.375 Chewy Pro S37 Skateboard Deck</h6>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <Link href={"/"} className="max-w-[384px] mx-auto">
                        <div className="w-full max-w-sm aspect-square overflow-hidden">
                            <Image src={"/catalog/sci-fi-device-tee-royal-01.webp"} width={100} height={100} alt="skateboard" className="w-full h-full object-cover transition-transform hover hover:scale-[1.3]"></Image>
                        </div>
                        <div className="mt-5 flex items-center justify-between">
                            <div className="">
                                <h6 className="font-medium text-[19px] leading-8 text-black mb-2">Palace 8.375 Charlie Pro S36 Skateboard Deck</h6>
                    ...
                    <Link href={"/"} className="max-w-[384px] mx-auto">
                        <div className="w-full max-w-sm aspect-square overflow-hidden">
                            <Image src={"/catalog/NM480EST_1.webp"} width={100} height={100} alt="skateboard" className="w-full h-full  object-cover transition-transform hover hover:scale-[1.3]"></Image>
                        </div>
                        <div className="mt-5 flex items-center justify-between">
                            <div className="">
                                <h6 className="font-medium text-[19px] leading-8 text-black mb-2">Palace 8.0 Brady Pro S36 Skateboard Deck</h6>
                    ...
                    <Link href={"/"} className="max-w-[384px] mx-auto">
                        <div className="w-full max-w-sm aspect-square overflow-hidden">
                            <Image src={"/catalog/01_7277082a-82ce-42a7-9ab6-cab173a2039b.webp"} width={100} height={100} alt="skateboard" className="w-full h-full  object-cover transition-transform hover hover:scale-[1.3]"></Image>
                        </div>
                        <div className="mt-5 flex items-center justify-between">
                            <div className="">
                                <h6 className="font-medium text-[19px] leading-8 text-black mb-2">Palace 8.375 Chewy Pro S37 Skateboard Deck</h6>
                    ...
                    <Link href={"/"} className="max-w-[384px] mx-auto">
                        <div className="w-full max-w-sm aspect-square overflow-hidden">
                            <Image src={"/catalog/NM574VBP-01.webp"} width={100} height={100} alt="skateboard" className="w-full h-full  object-cover transition-transform hover hover:scale-[1.3]"></Image>
                        </div>
                        <div className="mt-5 flex items-center justify-between">
                            <div className="">
                                <h6 className="font-medium text-[19px] leading-8 text-black mb-2">Palace 8.375 Chewy Pro S37 Skateboard Deck</h6>
